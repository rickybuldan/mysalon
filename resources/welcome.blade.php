				...
				<div class="header__area-menubar">
					<div class="header__area-menubar-left">
						<div class="header__area-menubar-left-logo">
							<a href="{{route('home')}}"><img style="width: 500px;height: 60px;" src="https://poincut.my.id/images/logo.jpg"></a>
            ...
            <div class="row">
                <div class="col-xl-8">
                    <div class="banner__three-title">
                        <span class="subtitle__one">Welcome to Our POINTCUT</span>
			...
			<div class="row">
				<div class="col-xl-4 col-lg-3 col-md-4 col-sm-8 sm-mb-30">
					<div class="footer__two-widget">
						...
						<img class="mt-5" style="width: 200px;height: 60px;" src="https://poincut.my.id/images/logo.jpg">
					</div>
				</div>

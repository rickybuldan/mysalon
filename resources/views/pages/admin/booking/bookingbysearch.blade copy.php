			...
			<div class="card-body ">
				...
				<div class="row px-4">
					...
					<div class="col-xl-2 col-md-12 col-sm-12">
						<div class="mt-4">
							<button class="btn btn-success" id="add-service-btn">Add service</button>
						</div>
					</div>
				</div>
				...
				<div class="row text-center px-4">
					<div class="col-xl-12 col-md-12 col-sm-12">
						<button type="button" id="book-btn" class="btn btn-primary"><i class="fa-solid fa-phone-volume me-2"></i>Save!</button>
					</div>
				</div>
			</div>

					...
					<div class="row">
						<div class="col-xl-12 col-md-12 col-sm-12">
							<div class="mb-3">
								...
								<input type="text" id="form-item-date" class="form-control form-item" readonly  value="">
							</div>
						</div>
					</div>
					<div class="mb-3">
						...
						<input type="text" class="form-control" placeholder="Name" id="form-name-customer" value="" readonly>
					...
					<div class="row">
						...
						<div class="col-xl-6 col-md-6 col-sm-6">
							<div class="mb-3">
								...
								<input type="text" class="form-control" id="form-phone-customer" placeholder="Phone" value="" readonly>
							</div>
						</div>
						<div class="col-xl-6 col-md-6 col-sm-6">
							<div class="mb-3">
								<label class="form-label">Email</label>
								<input type="email"  class="form-control" id="form-email-customer" placeholder="Email" value="" readonly>
							</div>
						</div>
					</div>

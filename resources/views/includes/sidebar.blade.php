    ...
    <div class="deznav-scroll">
        <ul class="metismenu" id="menu">
            ...
            <li><a href="{{ route('dashboard') }}" class="">
			 ...
			 <li class="menu-title">EMPLOYEE TASKS</li>
			
            <li><a href="{{ route('task') }}" class="">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
            ...
            @if (auth()->check() && (auth()->user()->roles->first()->role_name != 'Pemilik')  && (auth()->user()->roles->first()->role_name != 'Karyawan'))
            <li class="menu-title">TRANSACTIONS</li>
            <li><a href="{{route('booking')}}" class="">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g opacity="0.5">
            ...
            @if (auth()->check() &&  (auth()->user()->roles->first()->role_name !='Kasir') && (auth()->user()->roles->first()->role_name != 'Karyawan'))
            <li><a href="{{route('tracking')}}" class="">
                <div class="menu-icon">
                ...
                <span class="nav-text">Tracking Booking</span>
            </a>
            </li>
            @endif
            <li><a href="{{route('listbooking')}}" class="">
                    <div class="menu-icon">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g opacity="0.5">
            ...
            @endif
            @if (auth()->check() && (auth()->user()->roles->first()->role_name !='Pemilik') &&  (auth()->user()->roles->first()->role_name !='Kasir') && (auth()->user()->roles->first()->role_name != 'Karyawan'))
            <li class="menu-title">MASTER</li>
            @endif
            @if (auth()->check() && (auth()->user()->roles->first()->role_name === 'Superadmin') &&  (auth()->user()->roles->first()->role_name !='Pemilik') && (auth()->user()->roles->first()->role_name != 'Karyawan'))
            <li><a class="has-arrow " href="javascript:void(0);">
                ...
                <ul>
                    <li><a href="{{ route('users-manager') }}">Users Manager</a>
                        {{-- <ul>
            ...
            <ul>
                <li><a href="{{ route('products') }}">Setting Products</a>
                    {{-- <ul>
                        <li><a href="./user.html">User</a></li>
                        <li><a href="./edit-profile.html">Add User</a></li>
                        <li><a href="./app-profile-1.html">Profile 1</a></li>
            ...
            <li><a class="has-arrow " href="javascript:void(0);">
                ...
                <ul>
                    <li><a href="{{route('customers')}}">Customers Manager</a>
                        {{-- <ul>
                        <li><a href="./user.html">User</a></li>
                        <li><a href="./edit-profile.html">Add User</a></li>
                        <li><a href="./app-profile-1.html">Profile 1</a></li>
            ...
            <li><a class="has-arrow " href="javascript:void(0);">
                    ...
                    <span class="nav-text">Services Manager</span>
                </a>
                <ul>
                    {{-- <li><a href="./ui-accordion.html">Service Categories</a></li> --}}
